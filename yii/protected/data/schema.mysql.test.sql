...
-- База данных: `a_auto`
--
CREATE DATABASE IF NOT EXISTS `t_auto` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `t_auto`;

-- --------------------------------------------------------

--
-- Структура таблицы `t_action`
--
...
--
-- Структура таблицы `t_group_action`
--

CREATE TABLE IF NOT EXISTS `t_group_action` (
