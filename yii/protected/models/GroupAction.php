 ...
 */
class GroupAction extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('title, for_table', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, for_table', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'action' => array(self::HAS_MANY, 'Action', 'group_action_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('for_table',$this->for_table,true);
