...
class Request extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'group_request_id' => Yii::t('label', 'Статус заявки'),
			'title' => Yii::t('label', 'Название'),
			'name' => Yii::t('label', 'ФИО'),
			'firstname' => Yii::t('label', 'Фамилия'),
			'lastname' => Yii::t('label', 'Имя'),
			'patronymic' => Yii::t('label', 'Отчество'),
			'age' => Yii::t('label', 'Возраст'),
			'phone' => Yii::t('label', 'Телефон'),
			'work_phone' => Yii::t('label', 'Рабочий телефон'),
			'home_phone' => Yii::t('label', 'Домашний телефон'),
			'country_id' => Yii::t('label', 'Страна'),
			'city_id' => Yii::t('label', 'Регион регистрации'),
			'address' => Yii::t('label', 'Адрес'),
			'work_name' => Yii::t('label', 'Место работы'),
			'profit' => Yii::t('label', 'Доход за прошлый месяц'),
			'experience' => Yii::t('label', 'Стаж работы'),
			'passport' => Yii::t('label', 'Номер паспорта'),
			'driver_license' => Yii::t('label', 'Водительское удостоверение'),
			'is_kasko' => Yii::t('label', 'Заказать КАСКО'),
			'type_auto' => Yii::t('label', 'Тип авто'),
			'mark_id' => Yii::t('label', 'Марка'),
			'model_id' => Yii::t('label', 'Модель'),
			'compl' => Yii::t('label', 'Комплектация'),
