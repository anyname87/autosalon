...
class Request extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('phone, mark_id, model_id', 'required'),
			array('country_id, city_id, is_kasko, mark_id, model_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, title, name, firstname, lastname, patronymic, age, phone, work_phone, home_phone, country_id, city_id, address, work_name, profit, experience, passport, driver_license, is_kasko, type_auto, mark_id, model_id, compl, create_date, modify_date', 'safe', 'on'=>'search'),
		);
	}
